...
function App() {
  ...
  return (
    <div className="max-w-[85rem] pt-0 pb-4 md:pb-1 md:pt-1 md:px-4 lg:mx-auto w-full lg:flex items-center justify-center">
      <div className="w-full bg-blue-400 min-h-[44rem] lg:rounded-[2.5rem] md:my-10 overflow-hidden  md:rounded-2xl border flex flex-col md:flex-row">
        ...
        <section className="w-full md:w-[70%] border bg-slate-300 p-3 md:p-4 lg:p-10 lg:rounded-[2.5rem] rounded-2xl md:rounded-2xl">
          <Navbar
